...
import { Card, Button, Box, Stack, FormControl, InputLabel, MenuItem, Select, TextField, Typography  } from '@mui/material';
...
export default function PieceDetail() {
  ...
  return (
    ...
    <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
      ...
      >
      <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          <Iconify icon="fluent:box-16-regular"/>
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Product Details</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <FormControl variant="outlined" fullWidth sx={{ marginRight: 2 }}>
            <InputLabel htmlFor="quantity" sx = {{margin:'.5vh'}}>Quantity</InputLabel>
            <Select
              label="Quantity"
              id="quantity"
              name="quantity"
          ...
          <FormControl variant="outlined" fullWidth>
            <InputLabel htmlFor="units" sx = {{margin:'.5vh'}}>Units</InputLabel>
            <Select
              label="Units"
              id="units"
              name="units"
      ...
      >
        <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Details of Parcels</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField
            name="invoiceNo"
        ...
        <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Value under Section 14 of Customs Act</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField
            name="fob"
          ...
          />
          <FormControl variant="outlined" fullWidth>
            <InputLabel htmlFor="currency" sx = {{margin:'.5vh'}}>Currency*</InputLabel>
            <Select
              label="Currency"
              id="currency"
              name="currency"
        ...
        <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Custom Duties</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField
            name="exportDutyRate"
        ...
        <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Tax/Commercial Invoice</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField
            name="cth"
      ...
      <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
        ...
        <Typography variant="h4" sx={{ marginLeft: '10px' }}>GST Details</Typography>
      </Box>
      <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
        <TextField
          name="lutBondDetails"
      ...
      <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
        ...
        <Typography variant="h4" sx={{ marginLeft: '10px' }}>E-Commerce Particulars</Typography>
      </Box>
      <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
        <TextField
          name="ecommerce"
      ...
      <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
        ...
        <Typography variant="h4" sx={{ marginLeft: '10px' }}>Final Piece Information</Typography>
      </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <></>
        </Box>
