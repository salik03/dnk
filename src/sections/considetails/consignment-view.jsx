...
import { Button, Box, Stack, FormControl, InputLabel, MenuItem, Select, TextField, Typography, Card } from '@mui/material';
  ...
  return (
    ...
    <Stack direction="row" alignItems="center" justifyContent="space-between" mb={5}>
      ...
      <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Consignment Details</Typography>
        </Box>
        ...
        <FormControl variant="outlined" fullWidth sx={{ marginRight: 2 }} >
            <InputLabel htmlFor="selectPBE" sx={{ marginTop: 2, marginLeft:2 }}>Select PBE</InputLabel>
            <Select
              label="Select PBE"
              id="selectPBE"
              name="selectPBE"
      ...
      >
        <Box sx={{ backgroundColor: '#1877f2', color: 'white', padding: '10px', display: 'flex', alignItems: 'center' }}>
          ...
          <Typography variant="h4" sx={{ marginLeft: '10px' }}>Miscellaneous Details</Typography>
        </Box>
        <Box mt={1} sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'space-between' }}>
          <TextField
            name="invoiceNo"
